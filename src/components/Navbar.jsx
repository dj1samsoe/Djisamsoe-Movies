...
import dh1 from "../assets/images/dh1.png";
  ...
  return (
    <>
      ...
      <nav
        ...
        } fixed bg-zinc-900 md:bg-zinc-900 h-full w-full md:w-[15rem] z-30 md:block`}
      >
        <motion.div
          animate={{ scale: 1 }}
          initial={{ scale: 0 }}
        ...
        >
          <Link
            ...
            onClick={() => setActivemobile(!activemobile)}
          >
            <img src={dh1} alt="logo" className="w-24" />
            <h1 className="bg-gradient-to-r from-fuchsia-500 to-cyan-500 bg-clip-text text-transparent font-bold text-2xl text-center">
              Djisamsoe Movies
            </h1>
          </Link>
        </motion.div>
